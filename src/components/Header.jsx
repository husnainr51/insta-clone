...
export default function Header() {
  ...
  return (
    <div className="shadow-sm border-b sticky top-0 bg-white z-30 p-3">
      ...
      {isOpen && (
        <Modal
          className="max-w-lg w-[90%] p-6 absolute top-56 left-[30%] bg-white border-2 rounded-md shadow-md"
          isOpen={isOpen}
        ...
        >
          ...
          rounded-lg hover:brightness-105 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:hover:brightness-100"
          >
            Upload Post
          </button>
          <AiOutlineClose
